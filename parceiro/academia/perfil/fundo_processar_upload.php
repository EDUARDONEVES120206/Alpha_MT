...
$sqlVerificar = "SELECT caminho FROM tbfundo_acad WHERE login = '$login'";
...
if ($resultadoVerificar && mysqli_num_rows($resultadoVerificar) > 0) {
    ...
    if ($_FILES['imagem']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['imagem']['tmp_name'], $caminhoCompleto)) {
            ...
            $sqlAtualizar = "UPDATE tbfundo_acad SET caminho = '$caminhoCompleto' WHERE login = '$login'";
    ...
    if ($_FILES['imagem']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['imagem']['tmp_name'], $caminhoCompleto)) {
            ...
            $sqlInserir = "INSERT INTO tbfundo_acad (caminho, login) VALUES ('$caminhoCompleto', '$login')";
