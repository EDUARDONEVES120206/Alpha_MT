...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['excluir'])) {
        ...
        if ($bancoDeDados->executaSQL($sql)) {
            echo "<script language='javascript' type='text/javascript'>alert('Ficha de treino para antebraco excluída com sucesso.');window.location.href='../ficha_cadastradas.php';</script>";
        } else {
    ...
    <h1>Excluir Ficha de Treino para Antebraco</h1>
    
    <form action="excluir_ficha_antebraco.php" method="POST">
        <p>Você tem certeza de que deseja excluir a ficha de treino para antebraco?</p>
