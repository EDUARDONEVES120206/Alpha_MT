...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['excluir'])) {
        ...
        if ($bancoDeDados->executaSQL($sql)) {
            echo "<script language='javascript' type='text/javascript'>alert('Ficha de treino para triceps excluída com sucesso.');window.location.href='ficha_triceps';</script>";
        } else {
    ...
    <form action="excluir_ficha_triceps.php" method="POST">
        ...
        <a href="ficha_triceps.php">Não, Voltar</a>
    </form>
