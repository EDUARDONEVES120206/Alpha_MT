...
if ($exercicio1 != "") {
    $sql1 = "INSERT INTO tbtrapezio (login_usuario, nome_personal, telefone_personal, email_personal, exercicio1, series1, repeticoes1, exercicio2, series2, repeticoes2, exercicio3, series3, repeticoes3, exercicio4, series4, repeticoes4, exercicio5, series5, repeticoes5, exercicio6, series6, repeticoes6, exercicio7, series7, repeticoes7, exercicio8, series8, repeticoes8, observacao) VALUES ('$login_usuario', '$nome_personal', '$telefone_personal', '$email_personal', '$exercicio1', '$series1', '$repeticoes1', '$exercicio2', '$series2', '$repeticoes2', '$exercicio3', '$series3', '$repeticoes3', '$exercicio4', '$series4', '$repeticoes4', '$exercicio5', '$series5', '$repeticoes5', '$exercicio6', '$series6', '$repeticoes6', '$exercicio7', '$series7', '$repeticoes7', '$exercicio8', '$series8', '$repeticoes8', '$observacao')";
    if ($bancoDeDados->executaSQL($sql1)) {
        echo "<script language='javascript' type='text/javascript'>alert('Ficha de treino para trapezio salva com sucesso!!');window.location.href='../montar_ficha.php';</script>";
    } else {
        echo "<script language='javascript' type='text/javascript'>alert('Ficha ja cadastrada!!');window.location.href='../montar_ficha.php';</script>";
    }
}else{
    echo "<script language='javascript' type='text/javascript'>alert('Ops, ocorreu um erro. Tente novamente!!');window.location.href='ficha_trapezio.php';</script>";
}
