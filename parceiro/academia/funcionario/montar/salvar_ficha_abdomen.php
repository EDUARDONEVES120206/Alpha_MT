...
echo "<script language='javascript' type='text/javascript'>alert('Ops, ocorreu um erro. Tente novamente!!');window.location.href='ficha_abdomen.php';</script>";
}
