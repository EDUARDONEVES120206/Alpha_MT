...
<body>
    ...
    <div id="column">
     <h1>Montar Ficha de Treino para Antebraço</h1>
    <?php
    session_start();
    ...
    $sql1 = "SELECT login_usuario FROM tbantebraco WHERE login_usuario = '$login_usuario'";
    
    $result = $bancoDeDados->executaSQL($sql1);
    
    if (mysqli_num_rows($result) > 0) {
        echo "<h6>Esse usuario ja tem uma ficha de treino para antebraço cadastrado. Para excluir aperte ";
        echo "<a href='excluir_ficha_antebraco.php'>aqui!</a></h6>";
    } else {
        echo "<h6>Esse usuario não possui ficha de treino para antebraço cadastrado.</h6>";
    }
    ...
    <form action="salvar_ficha_antebraco.php" method="POST">
        <h2>Exercício 1:</h2>
