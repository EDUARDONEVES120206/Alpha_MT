...
<body>
    ...
    <div id="column">
        <h1>Montar Ficha de Treino para Pernas</h1>
        <?php
        session_start();
        ...
        $sql1 = "SELECT login_usuario FROM tbperna WHERE login_usuario = '$login_usuario'";

        $result = $bancoDeDados->executaSQL($sql1);

        if (mysqli_num_rows($result) > 0) {
            echo " <h6> Esse usuario ja tem uma ficha de treino para pernas cadastrado. Para excluir aperte ";
            echo "<a href='excluir_ficha_perna.php'>aqui!</a></h6>";
        } else {
        ...
        <form action="salvar_ficha_perna.php" method="POST">
            <h2>Exercício 1:</h2>
