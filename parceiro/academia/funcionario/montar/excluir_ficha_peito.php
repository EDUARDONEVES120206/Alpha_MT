...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['excluir'])) {
        ...
        if ($bancoDeDados->executaSQL($sql)) {
            echo "<script language='javascript' type='text/javascript'>alert('Ficha de treino para peito excluída com sucesso.');window.location.href='ficha_peito';</script>";
        } else {
    ...
    <form action="excluir_ficha_peito.php" method="POST">
        ...
        <a href="ficha_peito.php">Não, Voltar</a>
    </form>
